...
//            $this->__construct($orientation, $unit, $format, $unicode, $encoding, $diskcache);
//        }
        // SI NO FUNCIONA REGRESAR A __constructor
        public function TCPDF($orientation = 'P', $unit = 'mm', $format = 'A4', $unicode = true, $encoding = 'UTF-8', $diskcache = false) {
        ...
        public function setPageFormat($format, $orientation = 'P') {
            ...
            if (is_string($format)) {
                ...
                switch (strtoupper($format)) {
                    ...
                    case 'ETIQUETA': {
                            $format = array(287.71, 70.86);
                            break;
                    }
                    case 'ETIQUETA2': {
                            $format = array(221.89, 96.99);
                            break;
                    }
                    case 'ETIQUETA3': {
                            $format = array(221.89, 96.99);
